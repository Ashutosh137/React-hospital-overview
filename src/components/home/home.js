      ...
      <section className="section container text-center my-10 ">
        <section>
          ...
          <div className="section bg-white p-3 flex text-center">
            <div className="images  overflow-hidden w-full m-5 border-black border-2 rounded-tl-xl rounded-br-xl hover:opacity-90">
              <img
                alt="net error"
                className="h-full"
        ...
        <section>
          <div className="section  bg-white p-3 flex text-center">
            ...
            <div className="images w-full overflow-hidden m-5 border-black border-2 rounded-xl">
              <img
                alt="net error"
                className="h-full   "
