...
export const Depart = ({ depart }) => {
  return (
      <div className="w-[400px] xl:mx-10 mx-3 my-8 flex capitalize justify-center shadow-2xl shadow-slate-600  border-2 rounded-xl border-black bg-gray-200 px-4 flex-col hover:scale-110 transition-all ease-in z-50 ">
