    ...
    render() { 
        ...
        <footer className="footar flex capitalize text-center text-xs sm:text-xs xl:text-xl bg-black text-white">
          <div className="contact flex-col flex m-auto space-y-1 mt-1 px-1">
            <h2 className="text-sm mt-3 border-b border-b-stone-100 sm:text-2xl">contact us on</h2>
          ...
          <div className="location flex-col flex m-auto mt-1">
            <h2 className="text-sm mt-3 border-b border-b-stone-100 sm:text-2xl">locations</h2>
          ...
          <div className="links flex-col flex m-auto mt-1">
            <h2 className="text-sm mt-3 border-b border-b-stone-100 sm:text-2xl">quick links</h2>
          ...
          <div className="social flex-col flex m-auto my-1">
            <h2 className="text-sm mt-3 border-b border-b-stone-100 sm:text-2xl">follow us on</h2>
